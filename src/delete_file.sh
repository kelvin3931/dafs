...
swift -A https://192.168.111.94:8080/auth/v1.0 -U test:tester -K testing delete --all;
swift -A https://192.168.111.94:8080/auth/v1.0 -U test:tester -K testing post abc;
